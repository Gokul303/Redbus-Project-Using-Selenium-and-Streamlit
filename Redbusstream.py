...
# Andhra bus
lists_A=[]
df_A=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_A.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

# Kerala bus
lists_K=[]
df_K=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_K.csv")
for i,r in df_K.iterrows():
    lists_K.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_T.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_G.csv")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajasthan bus
lists_R=[]
df_R=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_R.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_SB.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Jammu Kashmir bus
lists_JK=[]
df_JK=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_JK.csv")
for i,r in df_JK.iterrows():
    lists_JK.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_H.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

# Assam bus
lists_AS=[]
df_AS=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_AS.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv(r"C:\Users\gokul\Desktop\capstoneproject\redbus\df_WB.csv")
...
# Home page setting 
if web=="Home":
    slt.image(r"C:\Users\gokul\Downloads\redBus Logo - PNG Logo Vector Brand Downloads (SVG, EPS).jpg",width=200)
    ...
    slt.markdown("Selenium, Python, Pandas, PyMySQL,pymysql-connector-python, Streamlit.")
    slt.subheader(":blue[Developed-by:]  Gokul Ram")

# States and Routes page setting
if web == "📍States and Routes":
    S = slt.selectbox("Lists of States", ["Andhra Pradesh", "Kerala ", "Telugana", "Goa", "Rajastan", 
                                          "South Bengal", "Jammu Kashmir", "Harayana", "Assam", "West Bengal"])
